...
Experiment 7 investigates the feasibility of integrating subject-driven approaches with classical data augmentation techniques. Consequently, we merge the most favourable subject-driven configurations with the top-performing classical technique, RandAugment. The conducted tests and their corresponding results are presented in Table \ref{table:TableExp07}. The column \textit{Variation} denotes the percentage difference in test accuracy before and after the inclusion of RandAugment.
